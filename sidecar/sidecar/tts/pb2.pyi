...
class Voice(_message.Message):
    __slots__ = ("id", "name", "language", "gender", "is_default")
    ...
    gender: str
    is_default: bool
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., language: _Optional[str] = ..., gender: _Optional[str] = ..., is_default: bool = ...) -> None: ...

class CreateVoiceRequest(_message.Message):
    __slots__ = ("voice_id", "audio_data", "name", "language", "gender")
    VOICE_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    language: str
    gender: str
    def __init__(self, voice_id: _Optional[str] = ..., audio_data: _Optional[bytes] = ..., name: _Optional[str] = ..., language: _Optional[str] = ..., gender: _Optional[str] = ...) -> None: ...

class CreateVoiceResponse(_message.Message):
    __slots__ = ("voice", "message")
    VOICE_FIELD_NUMBER: _ClassVar[int]
    MESSAGE_FIELD_NUMBER: _ClassVar[int]
    voice: Voice
    message: str
    def __init__(self, voice: _Optional[_Union[Voice, _Mapping]] = ..., message: _Optional[str] = ...) -> None: ...
